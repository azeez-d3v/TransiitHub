...
import 'set_date_model.dart';
export 'set_date_model.dart';
...
class _SetDateWidgetState extends State<SetDateWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SetDateModel());
  }
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 8.0, 0.0, 0.0),
                                child: Text(
                                  'Set the date of the availability of your booking.',
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
