...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFFAD1D);
  late Color secondary = const Color(0xFFDA6317);
  late Color tertiary = const Color(0xFF09051C);
  late Color alternate = const Color(0xFFFEF8E0);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFFFC668);
  late Color accent2 = const Color(0xFFE38751);
  late Color accent3 = const Color(0xFF444352);
  late Color accent4 = const Color(0xFFE3CBBC);
